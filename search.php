...
if (!empty($searchQuery)) {
    ...
    $sql = "SELECT * FROM products WHERE product_name LIKE '%$searchQuery%' ORDER BY product_name";
...
<head>
    ...
    <title>Search Results: <?php echo htmlspecialchars($searchQuery); ?> - GroceryHub</title>
...
<body>
    <header>
        ...
        <div class="search-container">
            <form action="search.php" method="GET">
                <input type="text" name="query" value="<?php echo htmlspecialchars($searchQuery); ?>" placeholder="Search for products...">
    ...
    <main>
        <section class="search-results">
            <h2>Search Results: "<?php echo htmlspecialchars($searchQuery); ?>"</h2>
            
            <?php if (empty($products)): ?>
            <p class="no-products">No products found matching your search.</p>
            <?php else: ?>
            <p class="results-count">Found <?php echo count($products); ?> products</p>
