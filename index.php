...
// Get featured products (e.g., 2 from each category)
$featuredProducts = [];
foreach ($categories as $category => $info) {
    $range = $info['range'];
    $sql = "SELECT * FROM products WHERE product_id BETWEEN {$range[0]} AND {$range[1]} LIMIT 2";
...
<head>
    ...
    <title>GroceryHub - Online Grocery Shopping</title>
